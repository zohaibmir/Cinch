        ...
        <section id="contact" class="page">
            <article id="contact-article">               
                <div class="row collapse">
                    <div class="large-3 medium-3 small-4 columns" id="contact-left" >
                    ...
                    <div class="large-6 medium-6 small-4 columns" id="contact-middle">
                        <div class="vcentere-content1">
                    ...
                    <div class="large-3 medium-3 small-4 columns" id="contact-right">
                        <div class="vcentere-content1">
