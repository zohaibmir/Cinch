        ...
        <section id="retailers" class="page">
            <article id="retailers-article">               
                <div class="row collapse">
                    <div class="large-3 medium-4 small-4 columns" id="retailers-left" >
                    ...
                    <div class="large-6 medium-4 small-4 columns" id="retailers-middle">
                        <div class="vcentere-content1">
                    ...
                    <div class="large-3 medium-4 small-4 columns" id="retailers-right">
                        <div class="vcentere-content1">
