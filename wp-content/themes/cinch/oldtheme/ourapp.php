        ...
        <section id="ourapp" class="page">
            <article id="app-article">               
                <div class="row collapse">
                    <div class="large-3 medium-4 small-4 columns" id="ourapp-left">
                    ...
                    <div class="large-6 medium-4 small-4 columns" id="ourapp-middle">
                        <div class="vcentere-content1">
                    ...
                    <div class="large-3 medium-4 small-4 columns" id="ourapp-right">
                        <div class="vcentere-content1">
