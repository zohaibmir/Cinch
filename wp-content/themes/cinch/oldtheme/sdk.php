        ...
        <section id="sdk" class="page">
            <article id="sdk-article">               
                <div class="row collapse">
                    <div class="large-3 medium-4 small-4 columns" id="sdk-left">
                    ...
                    <div class="large-6 medium-4 small-4 columns" id="sdk-middle">
                        <div class="vcentere-content1">
                    ...
                    <div class="large-3 medium-4 small-4 columns" id="sdk-right">
                        <div class="vcentere-content1">
