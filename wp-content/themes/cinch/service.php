        ...
        <section id="service" class="page">
            <article id="service-article">               
                <div class="row collapse">
                    <div class="large-3 medium-3 small-4 columns" id="service-left" >
                    ...
                    <div class="large-6 medium-6 small-4 columns" id="service-middle">
                        <div class="vcentere-content1">
                    ...
                    <div class="large-3 medium-3 small-4 columns" id="service-right">
                        <div class="vcentere-content1">
